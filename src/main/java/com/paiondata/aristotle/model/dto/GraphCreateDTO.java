...
public class GraphCreateDTO extends BaseEntity {
    ...
    /**
     * The OIDC ID of the user who owns the graph.
     *
     * <p>
     * This field is required and must not be blank. It uniquely identifies the user who owns the graph.
     * The OIDC ID can be a unique identifier such as a username or a user ID.
     *
     * @see Message#OIDCID_MUST_NOT_BE_BLANK
     */
    @ApiModelProperty(value = "The OIDC ID of the user who owns the graph. This field is required and must "
            + "not be blank. It uniquely identifies the user who owns the graph. The OIDC ID can be a unique "
